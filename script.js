...
// functions :
    ...
    function rollDice(){
        ...
        switch(diceResult){
            case 1 :
                diceFace.innerHTML = '<img src="./images/de-1.jpg" alt="dé, face 1">'
                break
            case 2 : 
                diceFace.innerHTML = '<img src="./images/de-2.jpg" alt="dé, face 2">'
                break
            case 3 : 
                diceFace.innerHTML = '<img src="./images/de-3.jpg" alt="dé, face 3">'
                break
            case 4 : 
                diceFace.innerHTML = '<img src="./images/de-4.jpg" alt="dé, face 4">'
                break
            case 5 : 
                diceFace.innerHTML = '<img src="./images/de-5.jpg" alt="dé, face 5">'
                break
            case 6 : 
                diceFace.innerHTML = '<img src="./images/de-6.jpg" alt="dé, face 6">'
                break
        }
